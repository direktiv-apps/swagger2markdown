...
//go:generate swagger generate server --target ../../app --name Swagger2markdown --spec ../swagger.yaml --principal interface{}

func configureFlags(api *operations.Swagger2markdownAPI) {
...
func configureAPI(api *operations.Swagger2markdownAPI) http.Handler {
